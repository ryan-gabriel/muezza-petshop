...
const StudioHeroSection = () => {
  const message = encodeURIComponent(
    "Halo Muezza Petshop, Saya tertarik dengan layanan studio. Bisakah kita berbicara?"
  );
  return (
      ...
      <div className="relative z-10 max-w-6xl mx-auto flex flex-col md:flex-row items-center md:items-start px-6 md:px-12 py-20 md:py-32">
        ...
        <div className="w-full md:w-1/2 text-center md:text-left">
          ...
          <p className="text-base md:text-lg text-justify mt-6 mb-10">
            Kamu bisa abadikan momen terbaik hewanmu dengan sesi foto yang nyaman dan aman. Kami siapkan studio yang bersih, pencahayaan yang pas, dan properti yang cocok untuk berbagai pose. Kamu cukup bawa hewanmu dan biarkan kami menangkap ekspresinya.
          </p>
          <a
